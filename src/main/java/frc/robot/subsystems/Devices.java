...
public class Devices {
    ...
    //Swerve Modules
    public static final DevSwerveModule frontLeftSwerveModule = new DevSwerveModule(talonFxSwerveDriveWheelFrontLeft,
            talonFxSwerveTurnWheelFrontLeft, true, true);
    public static final DevSwerveModule frontRightSwerveModule = new DevSwerveModule(talonFxSwerveDriveWheelFrontRight,
            talonFxSwerveTurnWheelFrontRight, true, true);
    public static final DevSwerveModule rearLeftSwerveModule = new DevSwerveModule(talonFxSwerveDriveWheelRearLeft,
            talonFxSwerveTurnWheelRearLeft, true, true);
    public static final DevSwerveModule rearRightSwerveModule = new DevSwerveModule(talonFxSwerveDriveWheelRearRight,
            talonFxSwerveTurnWheelRearRight, true, true);
