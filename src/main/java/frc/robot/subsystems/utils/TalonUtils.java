...
public class TalonUtils {
    ...
    public static void configureBaseTalon(DevTalonSRX talon, boolean motorInvert) {
        ...
        SupplyCurrentLimitConfiguration currentLimitConfig = new SupplyCurrentLimitConfiguration(true,
                PEAK_CONTINUOUS_AMPERAGE, PEAK_AMPERAGE, PEAK_AMPERAGE_DURATION);
    ...
    public static void configureTalonWithEncoder(DevTalonSRX talon, boolean sensorPhase, boolean motorInvert,
            PIDValues pid) {
        if (!talon.isConnected)
            return;
    ...
    public static void configureTalonWithEncoder(DevTalonFX talon, boolean sensorPhase, boolean motorInvert,
            PIDValues pid) {
        if (!talon.isConnected)
            return;
    ...
    public static void configureBaseTalonMasterFollower(DevTalonSRX talonM, DevTalonSRX talonF, boolean motorInvertM,
            boolean motorInvertF) {
        if (!talonM.isConnected || !talonF.isConnected)
            return;
    ...
    public static void configureBaseTalonMasterFollower(DevTalonFX talonM, DevTalonFX talonF, boolean motorInvertM,
            boolean motorInvertF) {
        if (!talonM.isConnected || !talonF.isConnected)
            return;
