...
public class SwerveMovement {
    ...
    public SwerveMovement(double xLeftSpeed, double yLeftSpeed, double xRightSpeed) {
        forwardBackwardSpeed = yLeftSpeed;
        sideToSideSpeed = xLeftSpeed;
        rotationSpeed = xRightSpeed;
    }
    ...
    public static SwerveMovement getMovement(XboxPositionAccessible controller) {
        ...
        SwerveMovement move = new SwerveMovement(pos.leftForwardBackPosition, pos.leftSideToSidePosition,
                pos.rightSideToSidePosition);
        return move;
    }
